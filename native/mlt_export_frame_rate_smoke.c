...
int main(int argc, char **argv)
{
    ...
    /*
     * The generated smoke fixture is 25 fps. Exporting source frames 0..24
     * therefore covers exactly one second. At 30000/1001 the output should
     * contain 30 frames while remaining approximately one second long.
     */
